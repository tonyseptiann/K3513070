	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container"> 
				...
				<a class="brand " href="#">FOSS CodeIgniter</a>
...
?>
				...
				<form class="form-horizontal well" method="POST" action="<?php echo base_url(); ?>auth/login">
					<fieldset> 
						...
						<div class="control-group">
							...
							<button type="submit" id="submit" class="btn btn-warning button" >Masuk</button>
	...
	<hr />
		<div class="span12">
			<footer>
			<p>&copy; Nur Hidayatur R, Puji Cahyo W, Toni Sepian N, Yuliana Ariyanti.</p>
			</footer>
		</div>
