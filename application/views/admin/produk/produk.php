			...
			<div class="span12">
				...
				<div class="row">
					...
					<div class="span9">
						...
						<marquee><h3>Customer Service Telp : 082226834049 | WhatsApp : 082226834049 | Pin BB : 7CBN456</h3></marquee><br />
						<!--<h5>Semua Produk berjumlah sebanyak: <?php echo $count; ?> record(s).</h5> -->
							...
							<table class="table table-striped table-bordered"><!-- table default style -->
								...
								?>
									...
									<td>
										...
										<!-- panggil modal -->
										<p><a data-toggle="modal" href="#example<?php echo $no;?>" class="btn btn-warning btn-small">Lebih besar</a></p>  
										<!-- end panggil modal -->
										</a>
									</td>
									<td>
										...
										<!-- panggil modal -->
										<p><a data-toggle="modal" href="#example1<?php echo $no;?>" class="btn btn-success btn-small">Selengkapnya</a></p>  
										<!-- end panggil modal -->
									</td>
									<td><?php echo ucwords($row->nama_kategori); ?></td>
									<td border="0">
										<button type="button" class="btn btn-warning btn-small"><a title="Edit Produk Produk" href="<?php echo base_url(); ?>administrator/edit_produk/<?php echo $row->id_produk; ?>">
											<i class="icon-edit"></i> Edit
										</a></button>
										<button type="button" class="btn btn-danger btn-small"><a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>administrator/hapus_produk/<?php echo $row->id_produk; ?>'}" title="Hapus Produk" >
											<i class="icon-trash"></i> Hapus
										</a></button>
										<button type="button" class="btn btn-info btn-small"><a title="Detail Produk" href="<?php echo base_url(); ?>administrator/detail_produk/<?php echo $row->id_produk; ?>" target="_blank">
